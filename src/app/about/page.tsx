    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <section className="about-hero">
                <div className="container">
                    <h1>{tText("About Project Alpha", "প্রজেক্ট আলফা সম্পর্কে")}</h1>
                ...
                <div className="container">
                    <div className="about-grid">
                        <div className="about-content">
                            ...
                            <p>{tText("Project Alpha is a leading investment platform in Bangladesh that connects investors with profitable opportunities. Founded in 2024, we've grown to serve thousands of satisfied investors across the country.", "প্রজেক্ট আলফা বাংলাদেশের একটি শীর্ষস্থানীয় বিনিয়োগ প্ল্যাটফর্ম যা বিনিয়োগকারীদের লাভজনক সুযোগের সাথে সংযুক্ত করে। ২০২৪ সালে প্রতিষ্ঠিত, আমরা সারা দেশে হাজার হাজার সন্তুষ্ট বিনিয়োগকারীদের সেবা দিতে বড় হয়েছি।")}</p>
            ...
            <section className="team-section">
                <div className="container">
                    <div className="section-header">
                        ...
                        <p>{tText("Meet the experts behind Project Alpha", "প্রজেক্ট আলফার পেছনের বিশেষজ্ঞদের সাথে পরিচিত হন")}</p>
                    </div>
                ...
                <div className="container">
                    ...
                    <div className="contact-grid">
                        <div className="contact-card">
                            ...
                            <p><a href="mailto:support@projectalpha.com">support@projectalpha.com</a></p>
                        </div>
                        <div className="contact-card">
                            <div className="icon">
