        ...
        <div className="min-h-screen flex flex-col">
            ...
            <section className="about-hero">
                <div className="container">
                    <h1>{tText("About SmartEarnBD", "স্মার্ট আর্ন বিডি সম্পর্কে")}</h1>
            ...
            <section className="team-section">
                <div className="container">
                    <div className="section-header">
                        ...
                        <p>{tText("Meet the experts behind SmartEarnBD", "স্মার্ট আর্ন বিডির পেছনের বিশেষজ্ঞদের সাথে পরিচিত হন")}</p>
                    </div>
